...
//// Genre kiezen
//var misdaad = document.querySelector('label > input[name="misdaad"]');
//var drama = document.querySelector('label > input[name="drama"]');
//var crime = document.querySelector('label > input[name="crime"]');
//var thriller = document.querySelector('label > input[name="thriller"]');
//var action = document.querySelector('label > input[name="action"]');
//
//var main = document.querySelector('main');
//
//misdaad.addEventListener('click', function(){
//  main.classList.toggle('misdaad');
//});
//
//drama.addEventListener('click', function(){
//  main.classList.toggle('drama');
//});
//
//crime.addEventListener('click', function(){
//  main.classList.toggle('crime');
//});
//
//thriller.addEventListener('click', function(){
//  main.classList.toggle('thriller');
//});
//
